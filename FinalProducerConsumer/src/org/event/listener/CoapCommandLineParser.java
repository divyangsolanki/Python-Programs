...
public class CoapCommandLineParser {
	private static final String ALL_TOPICS = "final";
	private static final String DEFAULT_BROKER_LIST = "localhost:9092";
	private static final String DEFAULT_SERVER_URI_COAP = "coap://localhost:5683/final";

	@Option(name = "--uri", usage = "coap Server URI")
	private String serverURICoap = DEFAULT_SERVER_URI_COAP;

	@Option(name = "--brokerlist", aliases = "-b", usage = "Broker list (comma-separated)")
	private String brokerList = DEFAULT_BROKER_LIST;

	@Option(name = "--resource", usage = "coap topic filters (comma-separated)")
	...
	public String getServerURICoap() {
		return serverURICoap;
	}
